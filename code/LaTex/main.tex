...
\begin{figure}[H]
	\begin{center}
\includegraphics[scale = 1.5]{HS/US1.png}
...
\begin{figure}[H]
	\begin{center}
\includegraphics[scale = 0.90]{UML/clase.jpeg}
...
\begin{figure}[H]
	\begin{center}
\includegraphics[scale = 1.0]{UML/entidad-relacion.jpeg}
...
El daltonismo es una alteración poco atendida, y si bien un sistema no puede ser la cura para este tipo de gente, si puede ser una herramienta para brindarles una mejor calidad de vida e inclusive brindarles un apoyo desde una etapa temprana para que el o la paciente que lo padece pueda saber y conocer más a fondo sobre este padecimiento.

Los sistemas apoyarán en cada momento al Oftalmólogo a que pueda diagnosticar de manera más prudente si el paciente tiene algún tipo de daltonismo.

Recordemos que el daltonismo es una alteración que no puede ser detectada por uno mismo y que aunque a la mayoria de la población le parece indiferente tiende a ser un problema que es más común de lo que parece, encontrando casos muy particulares en diferentes ámbitos del entretenimiento y la ciencia, se debe lograr un día la cura, pero por lo mientras poner un granito de arena, puede ayudar demasiado a aquel que la padece.
